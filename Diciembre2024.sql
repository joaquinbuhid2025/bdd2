...
CREATE TABLE dbo.MOVIMIENTOS (
    ...
    CajaID          INT      NOT NULL,
    Monto           INT      NOT NULL,      -- si us�s centavos: DECIMAL(18,2)
    Fecha           DATE     NOT NULL,
...
-- MOVIMIENTOS  (MovimientoOrigID en 0 por defecto; ajustalo si necesit�s enlazar ajustes)
